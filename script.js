...
const puzzleBank = [
  ...
  { prompt: '有8个球，其中一个略重。用天平最少称几次能找出重球？', options: ['2', '3', '4', '1', '5'], answer: 0, difficulty: 1 },
  { prompt: '一个房间有三个开关控制三盏灯（在另一房间），灯泡都是坏的。你只能进房间一次。如何确定哪个开关控制哪盏灯？', options: ['无法确定', '打开开关后长时间等待', '打开所有开关', '听声音', '摸温度'], answer: 0, difficulty: 1 },
  ...
  { prompt: '观察字符串：ABBA、BAAB、BABA、AABB、ABAB，哪一个与节奏不同？', options: ['ABBA', 'BAAB', 'BABA', 'AABB', 'ABAB'], answer: 4, difficulty: 2 },
  ...
  { prompt: '一个房间里有三个灯泡，分别由三个开关控制（在房间外）。你只能进房间一次。如何确定哪个开关控制哪个灯泡？', options: ['打开一个开关长时间，关闭，立即打开另一个，进房间', '打开两个开关，进房间', '打开所有开关，进房间', '无法确定', '打开一个开关5分钟，关闭，打开第二个，进房间'], answer: 0, difficulty: 2 },
  ...
  { prompt: '有3个开关控制3盏灯（在另一房间），灯泡都是好的。你只能进房间一次。如何确定哪个开关控制哪盏灯？', options: ['打开1号5分钟，关闭，打开2号，进房间', '打开1、2号开关，进房间', '打开所有开关，进房间', '无法确定', '打开1号长时间，关闭，立即打开2号，进房间'], answer: 0, difficulty: 2 },
  ...
  { prompt: '一个岛上有100个人，其中一些人有蓝眼睛，一些人有棕眼睛。没有人知道自己的眼睛颜色，也不能互相讨论。如果一个人确定自己的眼睛是蓝色的，他会在第二天中午离开。已知至少有一个人眼睛是蓝色的。第99天中午所有蓝眼睛的人同时离开了。岛上蓝眼睛的人有多少？', options: ['99', '100', '50', '取决于总数', '无法确定'], answer: 0, difficulty: 3 },
