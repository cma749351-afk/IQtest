...
const puzzleBank = [
  ...
  // 新增传统谜题
  { prompt: '一位逻辑学家去岛上，岛上有两种人：只说真话的骑士和只说假话的无赖。他遇到两个人A和B。A说："我们两个都是无赖。"B什么都没说。A和B分别是什么人？', options: ['A是无赖，B是骑士', 'A是骑士，B是无赖', '两人都是无赖', '两人都是骑士', '无法确定'], answer: 0 },
  { prompt: '有四个开关控制四盏灯（在另一个房间），你只能进房间一次。已知灯泡都是好的。如何确定哪个开关控制哪盏灯？', options: ['打开1、2号开关5分钟，关闭2号，打开3号，进房间', '打开所有开关，进房间', '打开1号10分钟，关闭，立即打开2、3号，进房间', '无法确定', '打开1、2号开关，进房间'], answer: 0 },
  { prompt: '有三个箱子，一个装两个红球，一个装两个蓝球，一个装一红一蓝。箱子标签都贴错了（如标"红红"的箱子不可能装两个红球）。你从其中一个箱子摸出一个球是红色，这个箱子最可能装什么？', options: ['两个红球', '两个蓝球', '一红一蓝', '无法确定', '看运气'], answer: 0 },
  { prompt: '五个不同颜色的房子住着五个不同国籍的人，抽不同品牌的烟，喝不同的饮料，养不同的宠物。已知：英国人住红房子，瑞典人养狗，丹麦人喝茶，绿房子在白房子左边，绿房子主人喝咖啡，抽Pall Mall烟的人养鸟，黄房子主人抽Dunhill烟，住中间房子的人喝牛奶，挪威人住第一间房子，抽Blends烟的人住养猫的人隔壁，养马的人住抽Dunhill烟的人隔壁，抽Blue Master烟的人喝啤酒，德国人抽Prince烟，挪威人住蓝房子隔壁，抽Blends烟的人有一个喝水的邻居。问：谁养鱼？', options: ['德国人', '瑞典人', '挪威人', '英国人', '丹麦人'], answer: 0 },
  { prompt: '一个监狱里有100个囚犯和100个盒子。每个盒子里有一张纸条，写着一个囚犯的编号（1-100）。囚犯依次进入房间，每人可以打开50个盒子查看。如果所有囚犯都找到自己的编号，所有人都释放；否则全部处决。囚犯们可以在进入前商议策略，但不能在进入后沟通。最佳策略的成功率是多少？', options: ['约31%', '约50%', '约75%', '约10%', '几乎0%'], answer: 0 },
  { prompt: '有三顶红帽子和两顶白帽子。三个人被蒙上眼睛，每人戴上一顶帽子，剩下的藏起来。摘下眼罩后，每个人能看到别人的帽子但看不到自己的。第一个人说："我不知道我帽子的颜色。"第二个人也说不知道。第三个人说："我知道我帽子的颜色了。"第三个人的帽子是什么颜色？', options: ['红色', '白色', '无法确定', '看情况', '以上都不是'], answer: 0 },
  { prompt: '一个村庄里，每个人都有一双不同颜色的眼睛（要么蓝要么棕）。没有人知道自己的眼睛颜色，也不能互相谈论。如果一个人确定自己的眼睛是蓝色的，他会在第二天中午离开村庄。已知至少有一个人眼睛是蓝色的。第一天没人离开，第二天也没人离开，第三天所有蓝眼睛的人同时离开了。村庄里有多少蓝眼睛的人？', options: ['3', '4', '5', '取决于总数', '无法确定'], answer: 0 },
  { prompt: '有9个外观相同的球，其中一个略重。用天平最少称几次能找出重球？', options: ['2', '3', '4', '1', '5'], answer: 0 },
  { prompt: '12个球中有一个重量不同（不知轻重），用天平最少称几次能找出该球并确定轻重？', options: ['3', '4', '5', '2', '6'], answer: 0 },
  { prompt: '有3个开关控制3盏灯（在另一房间），灯泡都是好的。你只能进房间一次。如何确定哪个开关控制哪盏灯？', options: ['打开1号5分钟，关闭，打开2号，进房间', '打开1、2号开关，进房间', '打开所有开关，进房间', '无法确定', '打开1号长时间，关闭，立即打开2号，进房间'], answer: 0 },
  { prompt: '一个正方形棋盘上有64个格子。去掉对角线的两个角，剩下62个格子。能否用31个2×1的多米诺骨牌完全覆盖？', options: ['不能', '能', '取决于摆放', '可能', '不确定'], answer: 0 },
  { prompt: '一个圆形蛋糕，只允许垂直切刀。最少切几刀能把蛋糕分成8等份？', options: ['3', '4', '5', '6', '7'], answer: 0 },
  { prompt: '你面前有两条路，一条通向自由，一条通向监狱。两个守卫，一个永远说真话，一个永远说假话。你不知道谁是谁。你只能问一个问题，应该问什么？', options: ['"如果我问你这条路是否通向自由，你会说是吗？"', '"这条路通向自由吗？"', '"他（指另一个守卫）会说什么？"', '"你们谁是说实话的？"', '"我该怎么走？"'], answer: 0 },
  { prompt: '一个岛上有100个人，其中一些人有蓝眼睛，一些人有棕眼睛。没有人知道自己的眼睛颜色，也不能互相讨论。如果一个人确定自己的眼睛是蓝色的，他会在第二天中午离开。已知至少有一个人眼睛是蓝色的。第99天中午所有蓝眼睛的人同时离开了。岛上蓝眼睛的人有多少？', options: ['99', '100', '50', '取决于总数', '无法确定'], answer: 0 },
  { prompt: '有4个人要在17分钟内过桥。过桥时间分别为1、2、5、10分钟。桥每次最多两人，必须有手电筒（只有一个）。如何安排使所有人过桥时间最短？', options: ['17分钟', '18分钟', '19分钟', '20分钟', '21分钟'], answer: 0 },
  { prompt: '一个房间有三个开关控制三盏灯（在另一房间），灯泡都是坏的。你只能进房间一次。如何确定哪个开关控制哪盏灯？', options: ['无法确定', '打开开关后长时间等待', '打开所有开关', '听声音', '摸温度'], answer: 0 },
  { prompt: '一个数字序列：1, 11, 21, 1211, 111221, 312211, ? 下一个数是多少？', options: ['13112221', '1113213211', '31131211131221', '132112213221', '以上都不是'], answer: 0 },
  { prompt: '有8个球，其中一个略重。用天平最少称几次能找出重球？', options: ['2', '3', '4', '1', '5'], answer: 0 },
